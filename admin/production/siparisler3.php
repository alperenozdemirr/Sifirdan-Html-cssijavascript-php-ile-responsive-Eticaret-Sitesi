...
<?php $siSay = $db->query("SELECT * from siparisler where siparis_durum=2 order by siparis_id DESC", PDO::FETCH_OBJ)->fetchAll();
...
$siparisler = $db->query("SELECT * from siparisler where siparis_durum=2 order by siparis_id DESC Limit $nereden,$kacar", PDO::FETCH_OBJ)->fetchAll();
 ?>
<head>
  <title>Kargodaki Siparişler</title>
</head>
        <!-- page content -->
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Siparişler - Kargodaki Siparişler</h3>
              </div>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end">
    ...
    <?php for ($i=1; $i<=$ssayisi; $i++) { ?> 
         ...
         <li class="page-item"><a class="page-link" href="siparisler3.php?s=<?php echo $i ?>"><?php echo $i ?></a></li>
