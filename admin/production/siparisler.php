...
<?php 
$siSay = $db->query("SELECT * from siparisler", PDO::FETCH_OBJ)->fetchAll();
$siparis_sayisi = count($siSay);
 $kid=$siparisler->kullanici_id;
...
$siparisler = $db->query("SELECT * from siparisler order by siparis_id DESC Limit $nereden,$kacar", PDO::FETCH_OBJ)->fetchAll();
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Tüm Siparisler Listesi<br>(<b><?php echo $siparis_sayisi; ?></b> Adet Toplam Sipariş Alınmıs Buğüne Kadar)</h3>
              </div>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end">
    ...
    <?php for ($i=1; $i<=$ssayisi; $i++) { ?> 
         ...
         <li class="page-item"><a class="page-link" href="siparisler.php?s=<?php echo $i ?>"><?php echo $i ?></a></li>
